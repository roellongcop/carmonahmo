...
/**
 * BirthingWeightProgressSearch represents the model behind the search form of `app\models\BirthingWeightProgress`.
 */
class BirthingWeightProgressSearch extends BirthingWeightProgress
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = BirthingWeightProgress::find();
    ...
    {
        $records = BirthingWeightProgress::find()
            ->alias('ba')
        ...
        return  [
            'title' => 'Birthing Weight Progress',
