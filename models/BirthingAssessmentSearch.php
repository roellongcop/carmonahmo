...
/**
 * BirthingAssessmentSearch represents the model behind the search form of `app\models\BirthingAssessment`.
 */
class BirthingAssessmentSearch extends BirthingAssessment
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['date', 'assessment', 'chief_complaint', 'intervention', 'status'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'assessment', $this->assessment])
            ->andFilterWhere(['like', 'chief_complaint', $this->chief_complaint])
    ...
    {
        $records = BirthingAssessment::find()
            ->alias('ba')
