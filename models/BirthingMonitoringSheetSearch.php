...
/**
 * BirthingMonitoringSheetSearch represents the model behind the search form of `app\models\BirthingMonitoringSheet`.
 */
class BirthingMonitoringSheetSearch extends BirthingMonitoringSheet
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['date', 'blood_pressure', 'pulse', 'respiration', 'urine_output', 'cvp_level', 'others', 'status'], 'safe'],
        ];
    }
    ...
    {
        $query = BirthingMonitoringSheet::find();
        ...
        $query->andFilterWhere(['like', 'blood_pressure', $this->blood_pressure])
            ...
            ->andFilterWhere(['like', 'respiration', $this->respiration])
            ->andFilterWhere(['like', 'urine_output', $this->urine_output])
            ->andFilterWhere(['like', 'cvp_level', $this->cvp_level])
    ...
    {
        $records = BirthingMonitoringSheet::find()
            ->alias('ba')
        ...
        return  [
            'title' => 'Birthing Monitoring Sheet',
